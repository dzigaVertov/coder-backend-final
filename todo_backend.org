...
***** DONE en profile
***** DONE en productos
**** DONE Agregar botón de comprar carrito
***** en carrito
**** DONE Arreglar render de carrito
**** DONE Arreglar presentación de usuario en profile
**** DONE Arreglar presentación de producto en vista producto
**** DONE Agregar usuario admin a base atlas
**** DONE Agregar error handling de la ruta web
*** DONE Borrar código de sockets
*** DONE Limpieza general
*** TODO Arreglar README
*** TODO Entrega
